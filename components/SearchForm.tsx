"use client"
import { zodResolver } from "@hookform/resolvers/zod";  // Зөв импорт хийсэн
        ...
        <Form {...form}>
            ...
            >
                <div className="grid w-full lg:max-w-sm items-center gap-1.5">
                    <FormField
                        control={form.control} // form-ийн control-ийг дамжуулна
                        name="location"  // Талбарын нэрийг тодорхойлно
                        render={({ field }) => (
                            <FormItem>
