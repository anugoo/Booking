...
import { Popover, Dialog, Disclosure, Transition, DialogPanel } from '@headlessui/react';
...
function Header() {
    ...
    return (
        <header className="bg-[#013B94] text-white p-4">
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <Popover.Group className="hidden lg:flex lg:gap-x-12">
                    <Popover className="relative">
                        ...
                        >
                            <Popover.Panel className="absolute left-0 top-full z-10 mt-1 w-72 max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5">
                                <div className="p-4">
                                    {products.map((item) => (
                                        <div key={item.name} className="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
                                            <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg group-hover:bg-gray-200">
                                                <item.icon className="h-6 w-6 text-[#813894] group-hover:text-blue-600" aria-hidden="true" />
                                            </div>
                                ...
                                <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                                    {callsToAction.map((item) => (
                                        ...
                                        >
                                            <item.icon className="h-5 w-5 flex-none text-[#813894]" aria-hidden="true" />
                                            {item.name}
                                        </a>
                                    ))}
                                </div>
